...
LABEL tags="Genomics"
LABEL maintainer="Wen-Wei Liao <wen-wei.liao@wustl.edu>, Xiaofei Wang <xiw4006@med.cornell.edu>, Andrea Sboner <ans2077@med.cornell.edu>"
...
COPY SalmonTE.py        $HOME/SalmonTE/
COPY SalmonTE_Stats.R   $HOME/SalmonTE/
COPY scripts/           $HOME/SalmonTE/scripts/
COPY reference/         $HOME/SalmonTE/reference/
COPY bin/               $HOME/SalmonTE/bin/
COPY test/              $HOME/SalmonTE/test/
COPY snakemake/         $HOME/SalmonTE/snakemake/
COPY example/           $HOME/SalmonTE/example/
COPY salmon/            $HOME/SalmonTE/salmon/
